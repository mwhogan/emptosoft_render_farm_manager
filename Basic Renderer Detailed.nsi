OutFile "Detailed Mode Client.exe"
Caption "ERFM (Beta) Client (Detailed Mode)"
...
VIAddVersionKey /LANG=1033-ENGLISH "FileDescription" "Emptosoft Render Farm Manager Client (Detailed Mode) (Version 0.4 - Beta)"
...
Render:
   ...
   ExecDos::exec /NOUNLOAD /ASYNC /DETAILED /TIMEOUT=100000000000 '"$TGLoc" -p "$World" -hide -exit -r -f $R0'
   Goto Render2
OutputLoc:
   ExecDos::exec /NOUNLOAD /ASYNC /DETAILED /TIMEOUT=100000000000 '"$TGLoc" -p "$World" -o "$OutputLoc" -hide -exit -r -f $R0'
   Goto Render2
Render2:
   Pop $0
   ExecDos::wait $0
